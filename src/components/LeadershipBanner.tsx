export const LeadershipBanner = () => {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-primary via-secondary to-accent py-2">
        ...
        <div className="flex justify-between items-center">
          <div className="w-24 h-24 overflow-hidden rounded-lg shadow-xl">
            <img
              ...
              className="w-full h-full object-contain bg-primary/80"
              loading="eager"
            />
          </div>
          <div className="w-24 h-24 overflow-hidden rounded-lg shadow-xl">
